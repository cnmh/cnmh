                ...
                <tr>
                    ...
                    <td style="width: 120px">
                        ...
                        <div class='btn-group'>
                            ...
                            <a href="{{ route('typeHandicaps.show', [$typeHandicap->id]) }}" class='btn btn-default btn-sm'>
                                <i class="far fa-eye"></i>
                            </a>
                            @endcan
                            @can('edit-TypeHandicap')
                            <a href="{{ route('typeHandicaps.edit', [$typeHandicap->id]) }}" class='btn btn-default btn-sm'>
